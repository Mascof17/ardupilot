...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_CUSTOM:
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_1,    -(std::sqrt(2)/std::sqrt(3))f,  (std::sqrt(2)/std::sqrt(3))f,   -(std::sqrt(2)/std::sqrt(3))f,     -(std::sqrt(2)/std::sqrt(3))f,    0,    (std::sqrt(2)/std::sqrt(3))f, 1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,    -(std::sqrt(2)/std::sqrt(3))f,  (std::sqrt(2)/std::sqrt(3))f,    (std::sqrt(2)/std::sqrt(3))f,   -(std::sqrt(2)/std::sqrt(3))f,   0,    -(std::sqrt(2)/std::sqrt(3))f,  2);
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_7,    (std::sqrt(2)/std::sqrt(3))f,   (std::sqrt(2)/std::sqrt(3))f,   (std::sqrt(2)/std::sqrt(3))f,    -(std::sqrt(2)/std::sqrt(3))f,    0,    -(std::sqrt(2)/std::sqrt(3))f,  7);
        add_motor_raw_6dof(AP_MOTORS_MOT_8,    (std::sqrt(2)/std::sqrt(3))f,  (std::sqrt(2)/std::sqrt(3))f,  -(std::sqrt(2)/std::sqrt(3))f,    -(std::sqrt(2)/std::sqrt(3))f,    0,   (std::sqrt(2)/std::sqrt(3))f,    8);
        break;
